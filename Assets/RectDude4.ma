...
//Name: RectDudeBase.ma
//Last modified: Sun, Nov 15, 2015 05:38:25 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.3560272845268706 4.6484583864595068 -0.25046203220341323 ;
	setAttr ".r" -type "double3" -6.9383527290952598 -2070.2000000000107 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "62C0DD5F-4CEC-5002-7BE7-0F9BB79E29D8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.0352408722216309;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "260E0382-4FC8-A465-B2E9-44B06CD62A8E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D61C7761-4573-456D-D384-90AF6F0CCAC5";
createNode displayLayer -n "defaultLayer";
	rename -uid "BD091075-4183-B0DB-DB6C-9DB0B1A4CBC2";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5959ED69-45C4-46BB-1E5B-E9A50438FE41";
...
createNode polyTweak -n "polyTweak1";
	...
	setAttr ".uopa" yes;
	setAttr -s 18 ".tk";
	setAttr ".tk[57]" -type "float3" 0.15109779 0 0.1510978 ;
	setAttr ".tk[58]" -type "float3" 0.15109779 0 0.075548872 ;
	setAttr ".tk[59]" -type "float3" 0.075548872 0 0.1510978 ;
	setAttr ".tk[60]" -type "float3" 0.075548872 0 0.075548872 ;
	setAttr ".tk[61]" -type "float3" -0.075548872 0 0.1510978 ;
	setAttr ".tk[62]" -type "float3" -0.1510978 0 0.1510978 ;
	setAttr ".tk[63]" -type "float3" -0.1510978 0 0.075548872 ;
	setAttr ".tk[64]" -type "float3" -0.075548872 0 0.075548872 ;
	setAttr ".tk[65]" -type "float3" -0.1510978 0 -0.075548872 ;
	setAttr ".tk[66]" -type "float3" -0.1510978 0 -0.15109779 ;
	setAttr ".tk[67]" -type "float3" -0.075548872 0 -0.15109779 ;
	setAttr ".tk[68]" -type "float3" -0.075548872 0 -0.075548872 ;
	setAttr ".tk[69]" -type "float3" 0.15109779 0 -0.15109774 ;
	setAttr ".tk[70]" -type "float3" 0.075548902 0 -0.15109779 ;
	setAttr ".tk[71]" -type "float3" 0.15109774 0 -0.075548872 ;
	setAttr ".tk[72]" -type "float3" 0.075548872 0 -0.075548902 ;
...
createNode file -n "file1";
	...
	setAttr ".ftn" -type "string" "C:/Users/Michael/Documents/maya/projects/default//sourceimages/3dPaintTextures/RectDudeBase/pCubeShape1_color.tga";
